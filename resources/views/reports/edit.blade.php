    ...
    <x-slot name="header">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">
                Perbarui informasi laporan dan tambahkan foto jika diperlukan.
            </p>
        </div>
    </x-slot>
        ...
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            >
                ...
                <div class="border-b border-gray-200 px-6 py-6">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Pilih jenis laporan yang sesuai dengan kondisi barang.
                    </p>
                    ...
                    <div class="mt-5 grid gap-4 sm:grid-cols-2">
                        ...
                        <label class="block cursor-pointer">
                            ...
                            <input
                                ...
                                value="LOST"
                                class="peer sr-only"
                                {{ old('type', $report->type) === 'LOST' ? 'checked' : '' }}
                            >
                        ...
                        <label class="block cursor-pointer">
                            ...
                            <input
                                ...
                                value="FOUND"
                                class="peer sr-only"
                                {{ old('type', $report->type) === 'FOUND' ? 'checked' : '' }}
                            >
                        ...
                        <div>
                            ...
                            >
                                ...
                                @foreach ($locations as $location)
                                    ...
                                    <option
                                        value="{{ $location->id }}"
                                        {{ old('location_id', $report->location_id) == $location->id ? 'selected' : '' }}
                                    >
                                        {{ $location->name }}
                                    </option>
                        ...
                        <div class="grid gap-5 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="event_date"
                                    name="event_date"
                                    value="{{ old('event_date', $report->event_date?->format('Y-m-d')) }}"
                                    class="mt-2 block w-full rounded-lg border-gray-300 text-sm shadow-sm focus:border-gray-500 focus:ring-gray-500"
                                >
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    id="contact_info"
                                    name="contact_info"
                                    value="{{ old('contact_info', $report->contact_info) }}"
                ...
                <div class="border-b border-gray-200 px-6 py-6">
                    ...
                    @else
                        ...
                        <div class="mt-5 rounded-lg border border-dashed border-gray-300 bg-gray-50 px-5 py-8 text-center">
                ...
                <div class="border-b border-gray-200 px-6 py-6">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Kamu dapat memilih lebih dari satu foto untuk ditambahkan.
                    </p>
