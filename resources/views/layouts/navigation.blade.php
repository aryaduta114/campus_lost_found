    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                ...
                <div class="shrink-0 flex items-center">
                    <a
                        ...
                        class="text-lg font-bold text-gray-800 hover:text-gray-600 transition"
                    >
                        Campus Lost & Found
                    </a>
                </div>
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-10 sm:space-x-6">
                    ...
                    @if (auth()->user()->role === 'STAFF')
                        <div class="flex items-center h-16 translate-y-0.5 ms-4">
                            <x-dropdown align="left" width="48">
                                ...
                                <x-slot name="content">
                                    ...
                                    <!-- Kelola Laporan -->
                                    <x-dropdown-link :href="route('staff.reports.index')">
                                        Kelola Laporan
                                    </x-dropdown-link>

                                    <!-- Kelola Klaim -->
                                    <x-dropdown-link :href="route('staff.claims.index')">
                                        Kelola Klaim
                                    </x-dropdown-link>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                ...
                <button
                    @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-600 hover:bg-gray-100 focus:outline-none transition duration-150 ease-in-out"
                >
                    <svg
                        class="h-6 w-6"
                        stroke="currentColor"
    ...
    >
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="px-4">
                ...
                <!-- Role -->
                @if (auth()->user()->role === 'STAFF')
                    <div class="mt-1 text-xs font-semibold text-gray-500 uppercase">
                        Staff
                    </div>
